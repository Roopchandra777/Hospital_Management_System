          ...
          try
          {
            ...
            if(loginId==1)
             ...
             //  System.out.println("doctor login");
              ...
              {
                JOptionPane.showMessageDialog(null,"You have entered Wrong Usernamme and password !");
           ...
           else if(loginId==3)
           {
              ...
              if(rs.next())
              {
               ...
               // System.out.println("res login");
                new ReceptionistHomePage(receptionistname,receptionist_id ,loginId,receptionist_username).setVisible(true);
                f.setVisible(false);
              }
              else
              {
