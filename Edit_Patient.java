...
public class Edit_Patient extends JFrame implements ActionListener
{
       ...
       try
        {
           ...
           if(rest0.next())
           {
               ...
               ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/icon/roop10.jpg"));
               ...
               try
                {
                  ...
                  while(rest.next())
                  {
                   ...
                   t11.setText(rest.getString("deceased"));
                   l1.add(t11);
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            {
                ConnectionClass obj= new ConnectionClass();
                String q2= "update patient set name='"+name+"',email='"+email+"',father_name='"+fname+"',phone='"+phone+"',material_status='"+material_status+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',dob='"+dob+"',deceased='"+deceased+"',address='"+address+"' where username='"+username+"'";
