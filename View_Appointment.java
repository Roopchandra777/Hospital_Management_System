...
{
    String x[] = {"Appointment_id", "Username","Name" ,"Email", "Father Name", "Phone", "Material status", "City", "Gender", "Bllod Group","Age", "DOB", "Deceased","Doctor","Appointment Date","Appointment Time","Appointment status"};
    JButton bt, bt1;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==bt)
        {
            ...
            try 
            {
                ...
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null,"Appointment Status Successfully Updated");
                    setVisible(false);
                }
                else
                {
