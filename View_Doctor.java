...
public class View_Doctor extends JFrame implements ActionListener 
{
    ...
    String x[] = {"Name", "Username", "DOB", "Address", "Phone", "Email", "City", "Gender", "Bllod Group", "age", "Clinic no", "Joining Date", "Spcialization", "Availablity"};
    JButton bt, bt1;
    ...
    View_Doctor(int login_id) {
        ...
        if(login_id==4)
        {
           ...
           bt1 = new JButton("Edit Doctor details");
