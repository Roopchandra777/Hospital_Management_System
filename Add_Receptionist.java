...
public class Add_Receptionist implements ActionListener
{
    ...
    Add_Receptionist()
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/icon/roop25.jpg"));
     ...
     public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            String joining_date = t11.getText();
            ...
            try
            {
                ...
                String q = "insert into receptionist values('"+res_id+"','"+name+"','"+username+"','"+password+"','"+email+"','"+fname+"','"+phone+"','"+qualification+"','"+city+"','"+gender+"','"+blood+"','"+age+"','"+dob+"','"+joining_date+"','"+address+"')";
                obj.stm.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"receptionist Details Successfully Submitted");
                f.setVisible(false);
            }
            catch(Exception ex)
            {
