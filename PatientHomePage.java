...
public class PatientHomePage extends JFrame implements ActionListener
{
   ...
   PatientHomePage(String patientname, String patient_id, int login_id, String username)
   {
    ...
    login__id=login_id;
    username2=username;
    ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Hospital/icon/roop17.jpg"));
...
//  JMenuItem ment5=new JMenuItem("Add Receptionist");
    ...
    JMenu men5=new JMenu("Hello, Sir("+patientname+")");
  ...
  //  ment5.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae)
    {
       ...
       if(comnd.equals("View Doctor"))
        ...
        {
            new CheckMyProfile(patient_id2,login__id);
            
        }
        else if(comnd.equals("Change Password"))
        {
            new Change_Password(patient_id2);
        }
