...
public class ReceptionistHomePage extends JFrame implements ActionListener
{
   ...
   ReceptionistHomePage(String receptionistname, String receptionist_id, int login_id, String username)
   {
    ...
    ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Hospital/icon/roop26.jpg"));
    Image Img=ic.getImage().getScaledInstance(1650, 830,Image.SCALE_SMOOTH);
    ImageIcon r1=new ImageIcon(Img);
    l1=new JLabel(r1);
    add(l1);
...
//  JMenuItem ment5=new JMenuItem("Add Receptionist");
    ...
    JMenu men5=new JMenu("Hi, Rreceptionist("+receptionistname+")");
  ...
  //  ment5.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae)
    {
       ...
       if(comnd.equals("View Doctor"))
        ...
        {
            new CheckMyProfile(receptionist_id2,login__id);
            
        }
        else if(comnd.equals("Change Password"))
        {
            new Change_Password(receptionist_id2);
        }
        else if(comnd.endsWith("Exit"))
         {
