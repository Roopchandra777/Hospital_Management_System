    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q = "insert into patient values('"+pat_id+"','"+name+"','"+username+"','"+password+"','"+email+"','"+fname+"','"+phone+"','"+material_status+"','"+city+"','"+gender+"','"+blood+"','"+age+"','"+dob+"','"+deceased+"','"+address+"')";
                obj.stm.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"Patient Details Successfully Submitted");
                f.setVisible(false);
            }
            catch(Exception ex)
            {
